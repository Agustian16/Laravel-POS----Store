...
<body>
    <div class="row">
        <div class="col-lg-12 margin-tb">
            <div class="pull-left">
                <h2 style=font-family: 'Balsamiq Sans', cursive;> Brands Data </h2>
            </div>
            <div class="pull-right">
                <a class="btn btn-success" style="margin-top:20px;" href="{{ route('brand.create') }}"><i class="fas fa-plus-circle"></i></a>
            </div>
        </div>
    </div>
        ...
        <tr>
            ...
            <td>
                <form action="{{ route('brand.destroy',$brand->kd_merek) }}" method="POST">
                    ...
                    <a href="{{ route('brand.edit', $brand->kd_merek) }}" title="edit">
